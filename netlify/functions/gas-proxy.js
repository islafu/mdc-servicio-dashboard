...
// Proxy simple a tu Web App de Google Apps Script (GAS)
// Usa la variable de entorno GAS_URL con tu URL /exec
...
exports.handler = async (event) => {
  ...
  try {
    // Construye URL (incluye querystring si viene)
    let url = GAS_URL;
    ...
    // Reenvía el content-type si existe
